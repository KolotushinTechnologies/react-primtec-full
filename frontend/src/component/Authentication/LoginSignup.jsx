  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Вход или Регистрация | Primtec" />
          <div className="LoginSignUpContainer">
            <div className="LoginSignUpBox">
              <div>
                <div className="login_signUp_toggle">
                  <p onClick={(e) => switchTabs(e, "login")}>Вход</p>
              ...
              <form className="loginForm" ref={loginTab} onSubmit={loginSubmit}>
                ...
                <input type="submit" value="Вход" className="loginBtn" />
                <Link to="/">
                  <span>Войдите как гость</span>
                </Link>
              </form>
