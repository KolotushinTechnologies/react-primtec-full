...
import AdvantagesPage from "./component/Advantages/Advantages";
     ...
     <Router>
      ...
      {stripeApiKey && (
       ...
       <Switch>
         ...
         <Route exact path="/pdn" component={PdnRules} />
         ...
         <ProtectedRoute isAdmin={true} exact path="/admin/post" component={CreatePost} />
